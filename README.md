...
2. Implemented direct manipulation instead of simple multiple-choice learning.
...
- The Layout checker is educational and is not a full EDA-grade verification engine.
- AI Tutor does not perfectly diagnose every coordinate-level Layout error.
