...
사용자가 단순히 문제를 푸는 것에서 끝나지 않고, 자신의 학습 상태와 다음 행동을 확인할 수 있도록 구성했습니다.
...
- Layout을 단순 그림이 아니라 전기적 연결 구조로 바라보도록 유도
...
학습 리포트는 단순 점수 경쟁을 넘어 개인별 학습 상태를 분석합니다.
